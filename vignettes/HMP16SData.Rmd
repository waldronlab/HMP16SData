...
controlled-access data, shotgun metagenomic data, or V13 variable region data.
For that reason, we would encourage the use of the
`r BiocStyle::Biocpkg("HMP16SData")` `SummarizedExperiment` class object with
