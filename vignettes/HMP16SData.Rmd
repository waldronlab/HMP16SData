...
`r BiocStyle::Biocpkg("HMP16SData")` provides methods to quickly translate 
taxonomic identifiers to NCBI taxonomy standard. The `translate_identifiers` 
...
As such, `r BiocStyle::Biocpkg("HMP16SData")` provides a method, `as.phyloseq`,
...
With no abundance taxa pruned, exploratory plots can be made trivally. For 
...
effort and the concept could be extended to compare and external dataset.
